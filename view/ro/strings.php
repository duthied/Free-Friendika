...
$a->strings["dark"] = "întunecat";
$a->strings["black"] = "negru";
$a->strings["Background Image"] = "Imagine Fundal";
$a->strings["The URL to a picture (e.g. from your photo album) that should be used as background image."] = "Adresa URL către o imagine (ex. dintr-un album foto) ce va fi folosită ca și imagine de fundal.";
$a->strings["Background Color"] = "Culoare Fundal";
$a->strings["HEX value for the background color. Don't include the #"] = "Valoarera HEX pentru culoarea de fundal. Nu include porțiunea #";
$a->strings["font size"] = "dimensiune font";
$a->strings["base font size for your interface"] = "dimensiunea de bază a fontului pentru interfața ta";
