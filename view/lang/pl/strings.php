...
$a->strings["Map"] = "Mapa";
$a->strings["<span><a href=\"%s\" target=\"_blank\" class=\"shared-wall-item-name\">%s</a> wrote the following <a href=\"%s\" target=\"_blank\">post</a>"] = "<span><a href=\"%s\" target=\"_blank\" class=\"shared-wall-item-name\">%s</a>napisał następujący<a href=\"%s\" target=\"_blank\">post</a>";
$a->strings["<a href=\"%1\$s\" target=\"_blank\">%2\$s</a> %3\$s"] = "<a href=\"%1\$s\" target=\"_blank\">%2\$s</a>%3\$s";
$a->strings["<span><a href=\"%s\" target=\"_blank\">%s</a> wrote the following <a href=\"%s\" target=\"_blank\">post</a>"] = "<span><a href=\"%s\" target=\"_blank\">%s</a>napisał następujący<a href=\"%s\" target=\"_blank\">post</a>";
...
$a->strings["config/local.ini.php is writable"] = "config/local.ini.php jest zapisywalny";
