...
$a->strings["Address of the relay server where public posts should be send to. For example %s"] = "Adresse des Relais-Servers, an den die öffentlichen Beiträge gesendet werden sollen. Zum Beispiel %s";
...
$a->strings["Your table_definition_cache is too low (%d). This can lead to the database error \"Prepared statement needs to be re-prepared\". Please set it at least to %d (or -1 for autosizing). See <a href=\"%s\">here</a> for more information.<br />"] = "Der Wert table_definition_cache ist zu niedrig (%d). Dadurch können Datenbank Fehler \"Prepared statement needs to be re-prepared\" hervor gerufen werden. Bitte setze den Wert auf mindestens %d (oder -1 zum automatischen einstellen). Weiterführende Informationen <a href=\"%s\">findest du hier</a>.";
