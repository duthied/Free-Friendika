...
$a->strings["The server is currently unavailable (because it is overloaded or down for maintenance). Please try again later."] = "Der Server ist derzeit nicht Verfügbar (wegen Überlastung oder Wartungsarbeiten). Bitte versuchen Sie es später noch einmal.";
