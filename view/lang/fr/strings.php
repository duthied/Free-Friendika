...
$a->strings['Show a community page widget with a list of the most popular tags in recent public posts.'] = 'Montre un encart avec la liste des étiquettes les plus populaires dans les publications récentes.';
...
$a->strings['Display sensitive content'] = 'Afficher le contenu sensible';
$a->strings['If enabled, pictures in posts marked as "sensitive" will not be blurred.'] = 'Si activé, les images dans les publications marquées comme "sensible" ne seront pas floutées.';
