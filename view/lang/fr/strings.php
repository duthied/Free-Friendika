...
$a->strings["If you are not yet a member of the free social web, <a href=\"%s\">follow this link to find a public Friendica site and join us today</a>."] = "Si vous n'êtes pas encore un membre du réseau sociale Libre, <a href=\"%s\">Suivez ce lien pour trouver une instance publique Friendica et nous rejoindre aujourd'hui</a>.";
$a->strings["Friend/Connection Request"] = "Requête de relation/amitié";
$a->strings["Examples: jojo@demo.friendica.com, http://demo.friendica.com/profile/jojo, testuser@gnusocial.de"] = "Exemples: jojo@demo.friendica.com, http://demo.friendica.com/profile/jojo, testuser@gnusocial.de";
...
$a->strings["Bandwidth Saver Mode"] = "Mode économiseur de bande-passante.";
...
$a->strings["Your profile will be published in the global friendica directories (e.g. <a href=\"%s\">%s</a>). Your profile will be visible in public."] = "Votre profil sera publié dans l'annuaire global de friendica (i.e. <a href=\"%s\">%s</a>). Votre profil sera visible publiquement.";
