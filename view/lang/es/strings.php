...
$a->strings["View Global Directory"] = "Ver Directorio Global";
...
$a->strings["Per default the notificiation are condensed to a single notification per item. When enabled, every notification is displayed."] = "Por defecto, la notificación se condensa en una sola notificación por artículo. Cuando está habilitado, se muestra cada notificación.";
