...
$a->strings["<p>Or you can open the following URL in your mobile devicde:</p><p><a href=\"%s\">%s</a></p>"] = "<p>Of je kan de volgende link op je mobiel openen:</p><p><a href=\"%s\">%s</a></p>";
