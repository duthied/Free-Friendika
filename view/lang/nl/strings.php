...
$a->strings['%s commented on this.'] = '%s hebben hierop gereageerd.';
...
$a->strings['%1$s replied to you on %2$s\'s %3$s %4$s'] = '%1$s reageerde op jou op %2$s\'s %3$s %4$s';
$a->strings['%1$s tagged you on %2$s\'s %3$s %4$s'] = '%1$s heeft jou getagd op %2$s\'s %3$s %4$s';
$a->strings['%1$s commented on %2$s\'s %3$s %4$s'] = '%1$s heeft een opmerking geplaatst op %2$s\'s %3$s %4$s';
$a->strings['%1$s replied to you on your %2$s %3$s'] = '%1$s reageerde op jou op je %2$s %3$s';
$a->strings['%1$s tagged you on your %2$s %3$s'] = '%1$s heeft je getagd op je %2$s %3$s';
$a->strings['%1$s commented on your %2$s %3$s'] = '%1$s heeft een opmerking geplaatst op jou %2$s %3$s';
$a->strings['%1$s replied to you on their %2$s %3$s'] = '%1$s reageerde op jou op hun %2$s %3$s';
$a->strings['%1$s tagged you on their %2$s %3$s'] = '%1$s heeft je getagd op hun %2$s %3$s';
...
$a->strings['%s %s shared a post from %s'] = '%s %s hebben een post gedeeld van %s';
$a->strings['%1$s shared a post from %2$s at %3$s'] = '%1$s hebben een post gedeeld van %2$s op %3$s';
$a->strings['%1$s [url=%2$s]shared a post[/url] from %3$s.'] = '%1$s [url=%2$s]deelde een post[/url] van %3$s.';
$a->strings['%1$s %2$s poked you'] = '%1$s %2$s heeft je gepoked';
$a->strings['%1$s poked you at %2$s'] = '%1$s heeft jou gepord op %2$s';
$a->strings['%1$s [url=%2$s]poked you[/url].'] = '%1$s [url=%2$s]porde jou[/url]';
$a->strings['%s %s tagged your post'] = '%s %s heeft je post getagged';
...
$a->strings['Enter your Webfinger address (user@domain.tld) or profile URL here. If this isn\'t supported by your system (for example it doesn\'t work with Diaspora), you have to subscribe to <strong>%s</strong> directly on your system'] = 'Voer hier uw webvingeradres (gebruiker@domein.tld) ​​of profiel-URL in. Als dit niet wordt ondersteund door uw systeem (het werkt bijvoorbeeld niet met Diaspora), moet u zich rechtstreeks op uw systeem abonneren met <strong>%s</strong>';
...
$a->strings['No items found'] = 'Geen items gevonden';
...
$a->strings['Expire photos'] = 'Laat foto\'s verlopen';
$a->strings['When activated, photos will be expired.'] = 'Wanneer geactiveerd, zullen foto\'s verlopen.';
...
$a->strings['Skip to main content'] = 'Ga naar hoofdinhoud';
$a->strings['Note'] = 'Nota';
...
$a->strings['Database storage failed to update %s'] = 'Database opslag faalde om %s te vernieuwen';
$a->strings['Database storage failed to insert data'] = 'Database opslag mislukt om gegevens in te voegen';
...
$a->strings['The password can\'t contain accentuated letters, white spaces or colons (:)'] = 'Het wachtwoord mag geen geaccentueerde letters, spaties of dubbele punten bevatten (:)';
...
$a->strings['Disable OpenID'] = 'Schakel OpenID uit';
$a->strings['Disable OpenID support for registration and logins.'] = 'Schakel OpenID-ondersteuning uit voor registratie en logins.';
$a->strings['No Fullname check'] = 'Geen Volledige-Naamscontrole';
...
$a->strings['Disable the automatic suppression of extraneous thread indentation.'] = 'Schakel de automatische onderdrukking van vreemd inspringen uit.';
$a->strings['Hide the Dislike feature'] = 'Verberg de Afkeeroptie';
$a->strings['Hides the Dislike button and dislike reactions on posts and comments.'] = 'Verbergt de knop Niet Leuk en Niet Leuke Reacties op berichten en opmerkingen.';
...
$a->strings['Forbidden'] = 'Niet toegestaan';
$a->strings['Not Found'] = 'Niet gevonden';
$a->strings['The server is currently unavailable (because it is overloaded or down for maintenance). Please try again later.'] = 'De server is momenteel niet beschikbaar (omdat deze overbelast is of niet beschikbaar is door onderhoud). Probeer het later opnieuw.';
...
$a->strings['At any point in time a logged in user can export their account data from the <a href="%1$s/settings/userexport">account settings</a>. If the user wants to delete their account they can do so at <a href="%1$s/removeme">%1$s/removeme</a>. The deletion of the account will be permanent. Deletion of the data will also be requested from the nodes of the communication partners.'] = 'Op elk gewenst moment kan een aangemelde gebruiker zijn gebruikersgegevens uitvoeren vanaf de <a href="%1$s/settings/userexport">gebruikersinstellingen</a>. Als de gebruiker zichzelf wenst te verwijderen, dan kan dat op <a href="%1$s/removeme">%1$s/removeme</a>. De verwijdering van de gebruiker is niet ongedaan te maken. Verwijdering van de gegevens zal tevens worden aangevraagd bij de nodes van de communicatiepartners.';
...
$a->strings['Unknown group command.'] = 'Onbekende groepsopdracht.';
$a->strings['Bad request.'] = 'Verkeerde aanvraag.';
...
$a->strings['Overwrite this field in case the determinated hostname isn\'t right, otherweise leave it as is.'] = 'Overschrijf dit veld voor het geval de bepaalde hostnaam niet juist is, laat het anders zoals het is.';
...
$a->strings['Sub path of the URL'] = 'Subpad van de URL';
