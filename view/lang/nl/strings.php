...
$a->strings["Post published."] = "Post gepubliceerd.";
...
$a->strings["Welcome back %s"] = "Welkom terug %s";
...
$a->strings["none"] = "geen";
$a->strings["Direct contacts"] = "Directe contacten";
$a->strings["Contacts of contacts"] = "Contacten van contacten";
...
$a->strings["The Terms of Service settings have been updated."] = "De instellingen voor Servicevoorwaarden zijn bijgewerkt.";
...
$a->strings["Submanaged account can't access the administation pages. Please log back in as the master account."] = "Beheerde gebruiker heeft geen toegang tot de beheerpagina's. Log opnieuw in als de hoofdgebruiker.";
...
$a->strings["Filetag %s saved to item"] = "Bestandstag %s bewaard bij item";
$a->strings["- select -"] = "- Kies -";
