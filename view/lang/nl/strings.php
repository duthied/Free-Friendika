...
$a->strings["Choose a profile nickname. This must begin with a text character. Your profile address on this site will then be \"<strong>nickname@%s</strong>\"."] = "Kies een profiel bijnaam. Deze dient te beginnen met een letter. Uw profiel adres op deze site zal dan \"<strong>nickname@%s</strong>\" zijn.";
