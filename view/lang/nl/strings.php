...
$a->strings["Mostly Male"] = "Hoofdzakelijk man";
$a->strings["Mostly Female"] = "Hoofdzakelijk vrouw";
...
$a->strings["Delegation"] = "Delegatie";
...
$a->strings["Show some informations regarding the needed information to operate the node according e.g. to <a href=\"%s\" target=\"_blank\">EU-GDPR</a>."] = "Toon wat inlichtingen over de nodige informatie om de node te beheren in overeenstemming met bvb. de <a href=\"%s\" target=\"_blank\">EU-GDPR</a> (EU-AVG).";
...
$a->strings["Contact is unavailable."] = "Contact is niet beschikbaar.";
$a->strings["Contact is deleted."] = "Contact is verwijderd.";
$a->strings["Contact is blocked, unable to add it to a group."] = "Contact is geblokkeerd, niet mogelijk om het aan een groep toe te voegen.";
...
$a->strings["No given contact."] = "Geen contact opgegeven.";
...
$a->strings["Choose a profile nickname. This must begin with a text character. Your profile address on this site will then be \"<strong>nickname@%s</strong>\"."] = "Kies een profiel bijnaam. Deze dient te beginnen met een letter. Uw profiel adres op deze sute zal dan \"<strong>nickname@%s</strong>\" zijn.";
