...
$a->strings['Reshared by %s'] = 'Reshared by %s';
$a->strings['Stored'] = 'Stored';
$a->strings['Global'] = 'Global';
$a->strings['Relayed'] = 'Relayed';
$a->strings['Relayed by %s.'] = 'Relayed by %s.';
$a->strings['Fetched'] = 'Fetched';
$a->strings['Fetched because of %s'] = 'Fetched because of %s';
...
$a->strings['%1$s replied to you on %2$s\'s %3$s %4$s'] = '%1$s replied to you on %2$s\'s %3$s %4$s';
$a->strings['%1$s tagged you on %2$s\'s %3$s %4$s'] = '%1$s tagged you on %2$s\'s %3$s %4$s';
$a->strings['%1$s commented on %2$s\'s %3$s %4$s'] = '%1$s commented on %2$s\'s %3$s %4$s';
$a->strings['%1$s replied to you on your %2$s %3$s'] = '%1$s replied to you on your %2$s %3$s';
$a->strings['%1$s tagged you on your %2$s %3$s'] = '%1$s tagged you on your %2$s %3$s';
$a->strings['%1$s commented on your %2$s %3$s'] = '%1$s commented on your %2$s %3$s';
$a->strings['%1$s replied to you on their %2$s %3$s'] = '%1$s replied to you on their %2$s %3$s';
$a->strings['%1$s tagged you on their %2$s %3$s'] = '%1$s tagged you on their %2$s %3$s';
...
$a->strings['%s %s tagged your post'] = '%s %s tagged your post';
...
$a->strings['Enter your Webfinger address (user@domain.tld) or profile URL here. If this isn\'t supported by your system (for example it doesn\'t work with Diaspora), you have to subscribe to <strong>%s</strong> directly on your system'] = 'Enter your WebFinger address (user@domain.tld) or profile URL here. If this isn\'t supported by your system (for example it doesn\'t work with Diaspora), you have to subscribe to <strong>%s</strong> directly on your system';
...
$a->strings['Normally emoticons are replaced with matching symbols. This setting disables this behaviour.'] = 'Normally emoticons are replaced with matching symbols. This setting disables this behaviour.';
...
$a->strings['Hide the Dislike feature'] = 'Hide the Dislike feature';
$a->strings['Hides the Dislike button and dislike reactions on posts and comments.'] = 'Hides the Dislike button and Dislike reactions on posts and comments.';
...
$a->strings['remote comment'] = 'remote comment';
