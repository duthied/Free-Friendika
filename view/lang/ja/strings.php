...
$a->strings['Our site encryption key is apparently messed up.'] = '当サイトの暗号化鍵が破損しているようです。';
...
$a->strings['%1$s welcomes %2$s'] = '%2$sさん、%1$sへようこそ';
$a->strings['This introduction has already been accepted.'] = 'この招待はすでに承諾されています。';
...
$a->strings['Introduction complete.'] = '招待が完了しました。';
