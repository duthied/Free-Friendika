...
$a->strings["%1\$s attends maybe %2\$s's %3\$s"] = "%1\$s可能参加了%2\$s的%3\$s";
$a->strings["%1\$s is now friends with %2\$s"] = "%1\$s 与 %2\$s 现已互为朋友";
$a->strings["%1\$s poked %2\$s"] = "";
$a->strings["%1\$s tagged %2\$s's %3\$s with %4\$s"] = "%1\$s 把 %2\$s 的 %3\$s 标记为 %4\$s";
$a->strings["post/item"] = "帖子/项目";
$a->strings["%1\$s marked %2\$s's %3\$s as favorite"] = "%1\$s 喜欢 %2\$s 的 %3\$s";
$a->strings["Select"] = "选择";
$a->strings["Delete"] = "删除";
