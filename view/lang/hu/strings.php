...
$a->strings["You can alternatively skip this procedure and perform a manual installation. Please see the file \"INSTALL.txt\" for instructions."] = "Alternatívaként kihagyhatja ezt az eljárást, és végezhet kézi telepítést. Az utasításokért nézze meg az „INSTALL.txt” fájlt.";
...
$a->strings["Url rewrite in .htaccess is not working. Make sure you copied .htaccess-dist to .htaccess."] = "A .htaccess fájlban lévő URL átírás nem működik. Győződjön meg arról, hogy lemásolta-e a .htaccess-dist fájlt .htaccess néven.";
...
$a->strings["Allowed OEmbed domains"] = "Engedélyezett OEmbed-tartományok";
$a->strings["Comma separated list of domains which oembed content is allowed to be displayed. Wildcards are accepted."] = "Azon tartományok vesszővel elválasztott listája, amelyekről a megjelenítendő OEmbed tartalom engedélyezett. A helyettesítő karakterek is elfogadottak.";
...
$a->strings["Don't use \"proc_open\" with the worker"] = "Ne használjon „proc_open” hívást a feldolgozóval";
$a->strings["Enable this if your system doesn't allow the use of \"proc_open\". This can happen on shared hosters. If this is enabled you should increase the frequency of worker calls in your crontab."] = "Akkor engedélyezze ezt, ha a rendszere nem teszi lehetővé a „proc_open” használatát. Ez osztott tárhelyszolgáltatóknál fordulhat elő. Ha ez engedélyezve van, akkor meg kell növelnie a feldolgozó hívásainak gyakoriságát a cron-feladatában.";
...
$a->strings["Enable frontend worker"] = "Előtétprogram-feldolgozó engedélyezése";
...
$a->strings["Your table_definition_cache is too low (%d). This can lead to the database error \"Prepared statement needs to be re-prepared\". Please set it at least to %d (or -1 for autosizing). See <a href=\"%s\">here</a> for more information.<br />"] = "A table_definition_cache értéke tál alacsony (%d). Ez a „Prepared statement needs to be re-prepared” adatbázishibához vezethet. Állítsa legalább %d értékre (vagy -1 értékre az automatikus méretezéshez). További információkért <a href=\"%s\">nézze meg ezt</a>.<br />";
