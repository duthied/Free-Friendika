...
$a->strings["CC: email addresses"] = "CC: e-post adressen";
...
$a->strings["Allowed email domains"] = "Toegelaten e-post domeinen";
$a->strings["Comma separated list of domains which are allowed in email addresses for registrations to this site. Wildcards are accepted. Empty to allow any domains"] = "Komma-gescheiden lijst van domeinen die gebruikt mogen worden in e-post adressen voor registraties op deze webstek. Jokers zijn toegelaten. Laat leeg om alle domeinen toe te laten.";
...
$a->strings["Show Community Page"] = "Toon Groep Pagina";
$a->strings["Display a Community page showing all recent public postings on this site."] = "Toon een groepspagina die alle recente openbare berichten op deze webstek toont.";
...
$a->strings["Registration successful. Please check your email for further instructions."] = "Registratie geslaagd. Kijk je e-post na voor verdere instructies.";
$a->strings["Failed to send email message. Here is the message that failed."] = "E-post bericht kon niet verstuurd worden. Hier is het bericht.";
...
$a->strings["Your Email Address: "] = "Je e-post adres:";
...
$a->strings["Failed to connect with email account using the settings provided."] = "Ik kon geen verbinding maken met het email account met de gegeven instellingen.";
$a->strings["Email settings updated."] = "E-post instellingen bijgewerkt..";
...
$a->strings[" Name too short."] = "Naam te kort.";
$a->strings["Wrong Password"] = "";
$a->strings[" Not valid email."] = "Geen geldig e-post adres.";
$a->strings[" Cannot change to that email."] = "Kan niet veranderen naar die e-post.";
...
$a->strings["Email Address:"] = "E-post Adres:";
...
$a->strings["joining a forum/community"] = "Lid worden van een forum of groep";
$a->strings["making an <em>interesting</em> profile change"] = "Een <em>interessante</em> verandering aan je profiel";
$a->strings["Send a notification email when:"] = "Stuur een notificatie e-post wanneer:";
...
$a->strings["This account has not been configured for email. Request failed."] = "Aanvraag mislukt. Dit account is niet geconfigureerd voor email.";
...
$a->strings["<strike>Connect as an email follower</strike> (Coming soon)"] = "<strike>Sluit aan als e-post volger</strike> (Binnenkort)";
...
$a->strings["Password reset request issued. Check your email."] = "Verzoek om wachtwoord opnieuw in te stellen werd verstuurd. Kijk uw e-post na.";
...
$a->strings["Enter your email address and submit to have your password reset. Then check your email for further instructions."] = "Geef je e-post adres en verstuur het om je wachtwoord opnieuw in te stellen. Kijk dan je e-post na voor verdere instructies.";
$a->strings["Nickname or Email: "] = "Bijnaam of e-post:";
...
$a->strings["On your <em>Settings</em> page -  change your initial password. Also make a note of your Identity Address. This looks just like an email address - and will be useful in making friends on the free social web."] = "Verander je initieel wachtwoord op je <em>Instellingen</em> pagina. Noteer ook het adres van je identiteit. Dit ziet er uit als een e-post adres - en zal nuttig zijn om vrienden te maken op het vrije sociale web.";
