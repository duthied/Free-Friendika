...
class Site extends BaseAdmin
{
	...
	public static function content(array $parameters = [])
	{
		...
		return Renderer::replaceMacros($t, [
			...
			'$proxify_content'        => ['proxify_content', DI::l10n()->t('Proxify external content'), DI::config()->get('system', 'proxify_content'), DI::l10n()->t('Redirect external content via the proxy functionality. This is used for example for some OEmbed accesses and in some other rare cases.')],
