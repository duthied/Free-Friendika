...
class Site extends BaseAdmin
{
	...
	public static function content(array $parameters = [])
	{
		...
		return Renderer::replaceMacros($t, [
			...
			'$enable_multi_reg'        => ['enable_multi_reg', DI::l10n()->t('Allow multiple registrations'), !DI::config()->get('system', 'block_extended_register'), DI::l10n()->t('Allow users to register additional accounts for use as pages.')],
