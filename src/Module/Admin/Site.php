...
class Site extends BaseAdmin
{
	...
	protected function content(array $request = []): string
	{
		...
		return Renderer::replaceMacros($t, [
			...
			'$enable_regfullname'     => ['enable_regfullname', DI::l10n()->t('Enable Fullname check'), !DI::config()->get('system', 'no_regfullname'), DI::l10n()->t('Check the box to only allow users to register which display name consists of at least two strings.')],
